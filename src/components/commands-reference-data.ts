...
export const COMMAND_CATEGORIES: CommandCategory[] = [
  ...
  },
  {
    id: "cat-tools",
    title: "Инструменты",
    description: "Действия бота в чате, не связанные с наказанием участников.",
    commands: [
      {
        key: "msg",
        command: "/msg",
        usage: [
          { label: "Текст сообщения", line: "/msg Текст сообщения" }
        ],
        description: "Отправляет сообщение в чат от имени бота — например, для объявлений. Команда удаляется сразу после обработки.",
        permission: "Управлять автомодерацией",
        tags: ["Причина не нужна", "Поддерживает HTML-разметку"],
        notes: ["Текст поддерживает то же форматирование, что свои команды и автоответы: <b>жирный</b>, <i>курсив</i>, ссылки и т.д."]
      }
    ]
  }
];
