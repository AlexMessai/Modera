...
const actionLabels: Record<string, string> = {
  ...
  MEMBER_STATUS_CHANGED: "Статус участника изменился в Telegram",
  MEMBER_JOIN_REQUESTED: "Подана заявка на вступление",
  ...
  AUTOMOD_LINK_TRIGGERED: "Обнаружена запрещённая ссылка",
  AUTOMOD_TERM_TRIGGERED: "Обнаружено запрещённое слово или фраза",
  AUTOMOD_MEDIA_TRIGGERED: "Обнаружен запрещённый тип контента",
  AUTOMOD_MENTIONS_TRIGGERED: "Обнаружены массовые упоминания",
  AUTOMOD_MENTIONS_DELETED: "Удалено за массовые упоминания",
  AUTOMOD_DUPLICATE_TRIGGERED: "Обнаружено повторяющееся сообщение",
  AUTOMOD_DUPLICATE_DELETED: "Удалено повторяющееся сообщение",
  AUTOMOD_SPAM_TRIGGERED: "Обнаружен флуд",
  ...
  MODERATION_EXPIRED_UNMUTE: "Mute снят по истечении срока",
  MODERATION_EXPIRED_UNBAN: "Блокировка снята по истечении срока",
  ...
  CHAT_SETTINGS_COPIED: "Настройки скопированы из другого чата",
  CHAT_INVITE_LINK_CREATED: "Создана пригласительная ссылка",
  CHAT_INVITE_LINK_UPDATED: "Изменена пригласительная ссылка",
  CHAT_INVITE_LINK_REVOKED: "Удалена пригласительная ссылка",
