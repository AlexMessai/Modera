...
function fallbackAvatar(displayName: string) {
  ...
  return `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 96 96" role="img" aria-label="${escapeXml(displayName)}"><rect width="96" height="96" rx="48" fill="#e9edf5"/><text x="48" y="52" text-anchor="middle" dominant-baseline="middle" fill="#394150" font-family="system-ui,sans-serif" font-size="38" font-weight="700">${escapeXml(initial)}</text></svg>`;
}
