...
export const JOURNAL_CATEGORIES = ["ALL", "MANUAL", "AUTOMOD", "ANTI_RAID", "ERRORS", "SETTINGS", "PENDING"] as const;
...
const ANTI_RAID_ACTIONS = [
  ...
  "RAID_MITIGATION_SKIPPED_PROTECTED",
...
const APPEAL_ACTIONS = [
  "APPEAL_SUBMITTED", "APPEAL_APPROVED", "APPEAL_REJECTED", "APPEAL_NOTIFICATION_FAILED"
];
...
const JOURNAL_ACTIONS = [
  ...MANUAL_ACTIONS, ...AUTOMOD_ACTIONS, ...ANTI_RAID_ACTIONS, ...TRUSTED_ACTIONS,
...
function auditActionFilter(category: JournalCategory): Prisma.StringFilter {
  switch (category) {
    ...
    case "ANTI_RAID": return { in: ANTI_RAID_ACTIONS };
