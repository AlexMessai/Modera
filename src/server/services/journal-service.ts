...
const JOURNAL_ACTIONS = [
  ...
  "REPORT_SETTINGS_UPDATED", "GLOBAL_REPORT_SETTINGS_UPDATED",
  "LOG_CHANNEL_LINKED", "LOG_CHANNEL_UNLINKED", "LOG_CHANNEL_SETTINGS_UPDATED",
  "CHAT_ROLE_UPDATED",
  "CONTENT_SETTINGS_UPDATED", "GLOBAL_CONTENT_SETTINGS_UPDATED",
  "AUTO_RESPONSE_CREATED", "AUTO_RESPONSE_UPDATED", "AUTO_RESPONSE_DELETED",
  "CUSTOM_COMMAND_CREATED", "CUSTOM_COMMAND_UPDATED", "CUSTOM_COMMAND_DELETED",
  "ADMIN_ACCOUNT_CREATED", "ADMIN_ACCOUNT_UPDATED", "ADMIN_SESSIONS_REVOKED",
  "ADMIN_ACCOUNT_SELF_REGISTERED",
  "CHAT_ADMIN_ACCESS_GRANTED", "CHAT_ADMIN_ACCESS_UPDATED", "CHAT_ADMIN_ACCESS_REVOKED",
